  ...
  return (
    <div className="bg-[#121212] min-h-screen flex items-center justify-center px-4" data-aos="zoom-in">
      <div className="bg-[#1E1E1E] p-8 rounded-lg border border-[#444444] w-full max-w-sm">
        <h2 className="text-2xl text-[#E0E0E0] font-semibold mb-6 text-center">Login to Your Account</h2>
        <form className="space-y-4">
          ...
          <button type="submit" className="w-full bg-[#888888] text-black py-2 rounded hover:bg-[#B0B0B0]">Login</button>
        </form>
      </div>
    </div>
  );
